...
We have also evaluated other options for storage with real time communication built into it. The table below outlines the aspects we considering during evaluation.
